...
import com.kato.scopedstorageapp.databinding.ActivityMainBinding
import java.io.File
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.downloadImageMediaLocation.setOnClickListener {
            fetchMediaLocation()
        }

        binding.downloadImageExternal.setOnClickListener {
            downloadImage()
        }
        binding.downloadImageInternal.setOnClickListener {
...
//Request Permission if not given
    ...
    private fun downloadFile() {
        ...
        val paint = Paint()
        canvas.drawText("This is Rajendrakumar Say Hello to u", 80F, 50F, paint)
        // finish the page
